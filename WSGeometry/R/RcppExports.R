...
StabilizedScaling_Rcpp <- function(cost_matrix, supply, demand, supply_div_type, demand_div_type, supply_div_parameters, demand_div_parameters, iter_max, epsvec, scaling_tol, final_tol, check_interval = 1L, indicator_slack = 1e-6, clamp = 1e100) {
    .Call('_WSGeometry_StabilizedScaling_Rcpp', PACKAGE = 'WSGeometry', cost_matrix, supply, demand, supply_div_type, demand_div_type, supply_div_parameters, demand_div_parameters, iter_max, epsvec, scaling_tol, final_tol, check_interval, indicator_slack, clamp)
}

Sinkhorn_Rcpp <- function(cost_matrix, supply, demand, supply_div_type, demand_div_type, supply_div_parameters, demand_div_parameters, iter_max, epsvec, scaling_tol, final_tol, thread_cnt = -1L, max_lines_per_work = 5L, indicator_slack = 1e-6) {
    .Call('_WSGeometry_Sinkhorn_Rcpp', PACKAGE = 'WSGeometry', cost_matrix, supply, demand, supply_div_type, demand_div_type, supply_div_parameters, demand_div_parameters, iter_max, epsvec, scaling_tol, final_tol, thread_cnt, max_lines_per_work, indicator_slack)
}
